        ...
        <View centerV spread padding-20 paddingB-5>
          <View row centerV>
            <Card.Section
              style={{ flexShrink: 1 }}
              content={[
                { text: '矿池', text65: true, $textDefault: true },
                { text: '矿池提供的矿池连接详细信息。我们为一些受欢迎的矿池提供预设。', text90: true, $textNeutral: true },
              ]}
            />
            <View paddingL-10>
              <Button size={Button.sizes.small} label="预设" onPress={() => setShowPoolListDialog(true)} />
            </View>
          </View>
        </View>
